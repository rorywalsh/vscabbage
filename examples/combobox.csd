<Cabbage>
{
    "widgets": [
        ...
        },
        {
            ...
            "channels": [
                { "id": "keyboard", "event": "valueChanged", "range": {"defaultValue": 0, "increment": 0.001, "max": 1, "min": 0, "skew": 1} }
            ]
        },
        {
            "type"    : "comboBox",
            ...
            "channels": [
                { "id": "waveform", "event": "valueChanged", "range": {"defaultValue": 0, "increment": 0.001, "max": 1, "min": 0, "skew": 1} }
            ],
