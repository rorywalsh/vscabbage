<Cabbage>
{
    "widgets": [
        ...
        { "type": "genTable", "bounds": {"left": 10, "top": 7, "width": 380, "height": 200}, "id": "gentable1", "tableNumber": 1 },
        {
            ...
            "channels": [
                { "id": "harm1", "range": {"min": 0, "max": 1, "value": 1, "skew": 1, "increment": 0.01} }
            ],
            "label"   : {"text": "Harm1"}
        },
        {
            ...
            "channels": [
                { "id": "harm2", "range": {"min": 0, "max": 1, "value": 0, "skew": 1, "increment": 0.01} }
            ],
            "label"   : {"text": "Harm2"}
        },
        {
            ...
            "channels": [
                { "id": "harm3", "range": {"min": 0, "max": 1, "value": 0, "skew": 1, "increment": 0.01} }
            ],
            "label"   : {"text": "Harm3"}
        },
        {
            ...
            "channels": [
                { "id": "harm4", "range": {"min": 0, "max": 1, "value": 0, "skew": 1, "increment": 0.01} }
            ],
            "label"   : {"text": "Harm4"}
        },
        {
            ...
            "channels": [
                { "id": "harm5", "range": {"min": 0, "max": 1, "value": 0, "skew": 1, "increment": 0.01} }
            ],
            "label"   : {"text": "Harm5"}
        },
        {
