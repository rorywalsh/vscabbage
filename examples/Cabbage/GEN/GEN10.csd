...
<Cabbage>
form caption("GEN10"), size(410, 354), pluginId("gn10"), colour("20,70,170,150"), guiMode("queue")

gentable bounds(  5,  5, 400, 120), channel("table1"), tableNumber(1), tableColour("yellow")
...
label    bounds(   2,341,110, 12), text("Iain McCurdy |2013|"), align("left")
</Cabbage>
