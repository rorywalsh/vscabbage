...
<Cabbage>
form size(385,340), caption("Live Looper"), guiRefresh(32), pluginId("LiLp"), colour("Black")
...
label bounds(  2,326,110, 12), text("Iain McCurdy |2015|"), align("left"), fontColour("Grey")
</Cabbage>
