...
<Cabbage>
form caption("MIDI Delay"), size(500, 120), pluginId("MiDl") colour(40,40,40), guiMode("queue")
...
label bounds(  2,107,110, 12), text("Iain McCurdy |2015|"), align("left"), fontColour("Silver")
