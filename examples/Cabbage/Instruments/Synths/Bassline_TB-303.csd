...
checkbox bounds( 10,285, 45, 13), text("Sub."), channel("sub"), value(0), fontColour:0("black"), fontColour:1("black")
button   bounds(330,310,100, 20), text("Clock: Internal","Clock: External"), channel("ClockSource"), value(0)                                                   
label    bounds(458,322,155, 12), text("Author: Iain McCurdy |2012|"), fontColour("black"), align("right")
