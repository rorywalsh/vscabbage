...
<Cabbage>
form caption("FOF Choir") size(770, 475), pluginId("choi"), guiMode("queue")

; main container
image           bounds(  0,  0,770, 475), colour(15,20,20), shape("rounded"), outlineColour("white"), outlineThickness(3)

label    bounds( 95, 100,80,40), text("Ahh"), align("centre"), fontColour("white"), channel("vowelText"), visible(0)

xypad    bounds( 10, 10,250,250), channel("vowelXY", "octXY"), text("X:Vowel Y:Oct.Div."), rangeX(0, 1, 0), rangeY(0, 4, 0), alpha(0.8)
...
keyboard bounds(10, 375,750, 80)

label    bounds( 10,457,110, 12), text("Iain McCurdy |2012|"), fontColour("silver"), align("left")
</Cabbage>
