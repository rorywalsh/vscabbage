...
<Cabbage>
form caption("Pad Synth"), size(1120, 483), pluginId("PdSy"), colour(0,0,0)
...
label  bounds(  0,40,635, 15), text("Click and Drag Here..."), align("centre"), colour(0,0,0,0), fontColour("white"), identChannel("instructions")
}               
...
vmeter   bounds(160, 30, 15, 65) channel("vMeter1") value(0) overlayColour(0, 0, 0, 255) meterColour:0(255, 0, 0) meterColour:1(255, 255, 0) meterColour:2(100,250, 0) outlineThickness(1)
vmeter   bounds(180, 30, 15, 65) channel("vMeter2") value(0) overlayColour(0, 0, 0, 255) meterColour:0(255, 0, 0) meterColour:1(255, 255, 0) meterColour:2(100,250, 0) outlineThickness(1)
...
label    bounds(  5,470,110, 12), text("Iain McCurdy |2015|"), fontColour("silver"), align("left")
</Cabbage>
...
instr 100
 ...
 Smsg              sprintfk            "fontColour(%d,%d,%d,%d)", kAlpha, kAlpha, kAlpha, kAlpha
                   chnset              Smsg,"instructions"
endin
