...
<Cabbage>
form caption("Ring Modulation Synthesizer") size(875,268), pluginId("RMSy"), colour(40,40,40)
...
label bounds(5,256,110,11), colour("black"), text("Iain McCurdy |2015|") align("left"), colour(0,0,0,0)
</Cabbage>
