...
<Cabbage>
form caption("CZ Synthesiser"), size(1075,375), pluginId("RMSy"), colour(40,40,40)
...
combobox   bounds(325, 20, 85, 20), channel("SALFOShape"), value(1), items("Tri.","Random")
...
combobox   bounds(445, 20, 85, 20), channel("FLFOShape"), value(1), items("Tri.","Random"), identChannel("ID10"), visible(0)
...
rslider    bounds(360, 40, 80, 80), valueTextBox(1), textBox(1), text("Level"), channel("Level"),  range(0,  1, 0.4), $SLIDER_STYLE
}

keyboard   bounds(  5,285,1065, 85)

label    bounds(  5,270,110, 12), text("Iain McCurdy |2015|"), align("left")
</Cabbage>
