...
; behaviour is different at different sample rates
...
label      bounds(878,  3,100,11), text("Iain McCurdy |2015|"), fontColour("DarkGrey"), align("left")
