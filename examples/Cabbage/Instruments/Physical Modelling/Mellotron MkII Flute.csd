...
<Cabbage>
form caption("Mellotron Mk.II Flute") size(655, 205), colour(255,255,240), pluginId("MlFl"), guiMode("queue")
...
label   bounds(  5, 82,100, 11), text("Iain McCurdy |2019|"), fontColour("DarkGrey"), align("left")
}
...
; lengths of the tape strips, note to note
giTapeLengths  ftgen  0, 0, 128, -21, 6, 1
...
kResNoise   cabbageGetValue    "ResNoise"
...
iStrip     cabbageGetValue    "Strip"
if iStrip==1 then
 if timeinsts:k()>=(7.5+table:i(iNote,giTapeLengths)) then                          ; if duration of this note exceeds 7.5 seconds (tape strips of the original were between 7 and 8 seconds.
...
; Vibrato
kModDepth   cabbageGetValue    "VibDepth"
kModRate    cabbageGetValue    "VibRate"
...
; Wind Noise
aTap        streson            rand:a(0.03), kCPS, 0.95      ; pass some noise through a harmonic resonator    
...
; Tape Hiss
aHiss       dust2              0.43 * cabbageGetValue:k("Hiss"), 8000
...
; Crackle
kCrackleMix cabbageGetValue    "CrackleLevel"
kDensity    cabbageGetValue    "CrackleDensity"
...
kHum        cabbageGetValue    "Hum"
k50Hz       cabbageGetValue    "50Hz"
k60Hz       cabbageGetValue    "60Hz"
