...
<Cabbage>
form caption("Honk") size(700, 455), pluginId("Honk"), colour("LightGrey") guiMode("queue")
image      bounds(  0,  0,700, 455), colour(50,50,100), outlineColour("LightGrey"), outlineThickness(1)
...
label bounds(5,443,100,11), text("Iain McCurdy |2014|"), fontColour("white"), align("left")
</Cabbage>
...
instr    1        ; WGBOWEDBAR INSTRUMENT
 ...
 gkvel             cabbageGetValue     "vel"
 /* BOW POSITION */
 gkpos             cabbageGetValue     "pos"                                ; bow position
 kpos              portk               gkpos, kporttime
 gkPosModDep       cabbageGetValue     "PosModDep"
 gkPosModRte       cabbageGetValue     "PosModRte"
 ...
 /* BOW PRESSURE */    
 gkbowpres         cabbageGetValue     "bowpres"
 kbowpres          portk               gkbowpres, kporttime
 gkBowPresDep      cabbageGetValue     "BowPresDep"
 gkBowPresRte      cabbageGetValue     "BowPresRte"
 ...
 iBowPresVel       cabbageGetValue     "BowPresVel"                            ; velocity influence of
 ...
 gkAEnv            cabbageGetValue     "AEnv"                                  ; amount of envelope influence. If this is zero, 'Att.Tim.', 'Dec.Tim' 'Sus.Lev." and 'Rel.Tim.' will have no influence
 gkAAttTim         cabbageGetValue     "AAttTim"
 gkADecTim         cabbageGetValue     "ADecTim"
 gkASusLev         cabbageGetValue     "ASusLev"
 gkARelTim         cabbageGetValue     "ARelTim"
 ...
 gkgain            cabbageGetValue     "gain"                            ; called 'feedback' in the GUI
 gkconst           cabbageGetValue     "const"                           ; called 'Discord' in the GUI
 ...
 gkOutGain         cabbageGetValue     "OutGain"                            ; called 'Level' in the GUI. Controls output level.
