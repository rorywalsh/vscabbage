...
<Cabbage>
form caption("Drum Pads") size(850, 430), pluginId("DPds"), colour("Black"), guiMode("queue")
...
label bounds(  2,420,110, 10), text("Iain McCurdy |2012|"), align("left"), fontColour("DarkGrey")
</Cabbage>
...
instr    1
 ...
 gkMOUSE_X         cabbageGetValue  "MOUSE_X"
 gkMOUSE_Y         cabbageGetValue  "MOUSE_Y"
