...
<Cabbage>
form caption("Image Switches") size(500, 435), pluginId("ImSw"), colour(50,50,50), guiMode("queue")
...
label bounds(398,424,100, 11), text("Iain McCurdy |2013|"), fontColour(110,110,110), align("right")
</Cabbage>                                                                                                          
...
while iRow < 9 do
 ...
 while iClm < 12 do
  ...
  SWidget            sprintf   "bounds(%d,%d,32,32), colour(0,0,0), corners(5), channel(%s), toFront(1)", 39 + iClm*35, 39 + iRow*35, SChan
...
instr    2    ; produce a sound
 ...
 kSoundSelect     cabbageGetValue    "SoundSelect"
 kSoundSelect     init      2
 kSoundSelectD    delayk    kSoundSelect,iCF_Time    ; delayed 'SOUND' selector control

 kOctave          cabbageGetValue    "Octave" 
 kSemitone        cabbageGetValue    "Semitone" 
 kStrike          cabbageGetValue    "Strike"
 ...
 kModifier        cabbageGetValue    "Modifier"
