...
<Cabbage>
form caption("Bouncing Object"), size(390, 648), pluginId("bnOb"), colour("Black")

#define RSliderStyle trackerColour(255,255,255), colour(100,200,140), outlineColour(40,40,40), textColour("white"), valueTextBox(1)

image      bounds(  5,  5,380, 70), colour( 50,100, 70), outlineColour("white"), line(2), shape("sharp"), plant("main")
{
filebutton bounds(  5,  8, 80, 25), text("Open File","Open File"), fontColour("white") channel("filename"), shape("ellipse"), corners(10), colour:0(255,255, 5, 80)
button     bounds(  5, 37, 80, 25), channel("GestureTrigger"), text("Trigger","Trigger"), value(0),               latched(0), corners(10), colour:0(255,255, 5, 80)
...
gentable   bounds(175,  5,200, 80), identChannel("table1"), tableNumber(1), tableColour("lime"), ampRange(0.01,1,1), zoom(-1), fill(0)
}
...
label      bounds(1, 635,110, 12), text("Iain McCurdy |2014|"), align("left"), fontColour("silver")
</Cabbage>
