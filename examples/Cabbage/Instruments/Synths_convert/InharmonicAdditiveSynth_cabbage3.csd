...
[
    {
        "type": "form",
        "colour": {"fill": "#000000"},
        "caption": "Inharmonic Synth",
        "size": {"width": 760, "height": 335},
        "pluginId": "InSy"
    },
    {
        "type": "groupBox",
        "font": {"size": 11},
        "channel": "groupBox_247",
        "bounds": {"left": 10, "top": 10, "width": 260, "height": 110},
        ...
        "children": [
            {
                ...
                "bounds": {"left": 0, "top": 25, "width": 60, "height": 80},
                "text": "Att.",
                "channel": "AAtt",
                "range": {"min": 0.0001, "max": 1.0, "defaultValue": 0.0001, "skew": 0.25, "increment": 0.0001}
            },
            {
                "type": "rotarySlider",
                "font": {"size": 9},
                "colour": {"tracker": {"background": "#222222", "width": 14}},
                "bounds": {"left": 50, "top": 25, "width": 60, "height": 80},
                "text": "Dec.",
                "channel": "ADec",
                "range": {"min": 0.001, "max": 30.0, "defaultValue": 7, "skew": 0.5, "increment": 0.001}
            },
            {
                "type": "rotarySlider",
                "font": {"size": 9},
                "colour": {"tracker": {"background": "#222222", "width": 14}},
                "bounds": {"left": 100, "top": 25, "width": 60, "height": 80},
                "text": "Sus.",
                "channel": "ASus",
            ...
            },
            {
                ...
                "font": {"size": 9},
                "colour": {"tracker": {"background": "#222222", "width": 14}},
                "bounds": {"left": 150, "top": 25, "width": 60, "height": 80},
                "text": "Rel.",
                "channel": "ARel",
                "range": {"min": 0.01, "max": 30.0, "defaultValue": 7, "skew": 0.5, "increment": 0.001}
            },
            {
                "type": "rotarySlider",
                "font": {"size": 9},
                "colour": {"tracker": {"background": "#222222", "width": 14}},
                "bounds": {"left": 200, "top": 25, "width": 60, "height": 80},
                "text": "Level",
                "channel": "Lev",
                "range": {"min": 0, "max": 5.0, "defaultValue": 0.1, "skew": 0.5, "increment": 0.001}
            }
        ]
    },
    {
        "type": "groupBox",
        "font": {"size": 11},
        "channel": "groupBox_248",
        "bounds": {"left": 275, "top": 10, "width": 160, "height": 110},
        "text": "Instrument",
        "children": [
            {
                "type": "comboBox",
                ...
                "indexOffset": true,
                "channel": "Instr",
                "bounds": {"left": 10, "top": 40, "width": 140, "height": 25}
            }
        ]
    },
    {
        "type": "groupBox",
        "font": {"size": 11},
        "channel": "groupBox_249",
        "bounds": {"left": 440, "top": 10, "width": 160, "height": 110},
        "text": "Random",
        "children": [
            {
                "type": "rotarySlider",
    ...
    },
    {
        "type": "groupBox",
        "font": {"size": 11},
        "channel": "groupBox_250",
        "bounds": {"left": 610, "top": 10, "width": 140, "height": 110},
        "text": "Ring Modulation",
        "children": [
            {
                "type": "checkBox",
                "font": {"colour": {"on": "#dddddd", "off": "#000000"}, "size": 8},
                "bounds": {"left": 10, "top": 30, "width": 60, "height": 15},
                "channel": "RMOnOff",
                "text": "On/Off"
            },
            {
                ...
                "font": {"size": 9},
                "colour": {"tracker": {"background": "#222222", "width": 14}},
                "bounds": {"left": 70, "top": 25, "width": 60, "height": 80},
                "text": "Freq.",
                "channel": "RMFreq",
                "range": {"min": -5000, "max": 5000, "defaultValue": -350, "skew": 1, "increment": 1}
            }
        ]
    },
    {
        "type": "groupBox",
        "font": {"size": 11},
        "channel": "groupBox_251",
        "bounds": {"left": 10, "top": 125, "width": 260, "height": 110},
        ...
        "children": [
            {
                ...
                "text": "Amount",
                "channel": "FAmt",
                "range": {"min": 0, "max": 10.0, "defaultValue": 8, "skew": 1, "increment": 0.001}
            },
            {
                "type": "rotarySlider",
                "font": {"size": 9},
            ...
            },
            {
                ...
                "text": "Rel.",
                "channel": "FRel",
                "range": {"min": 0.1, "max": 30.0, "defaultValue": 7, "skew": 0.5, "increment": 0.001}
            },
            {
                "type": "rotarySlider",
                "font": {"size": 9},
                ...
                "text": "Offset",
                "channel": "F_OS",
                "range": {"min": -4, "max": 10.0, "defaultValue": 0, "skew": 1, "increment": 0.001}
            }
        ]
    },
    {
        "type": "groupBox",
        "font": {"size": 11},
        "channel": "groupBox_252",
        "bounds": {"left": 275, "top": 125, "width": 160, "height": 110},
        "text": "Chorus",
        "children": [
            {
                "type": "rotarySlider",
            ...
            },
            {
                ...
                "text": "Depth",
                "channel": "ChoDep",
                "range": {"min": 0, "max": 0.1, "defaultValue": 0.01, "skew": 0.5, "increment": 0.001}
            },
            {
                "type": "rotarySlider",
                "font": {"size": 9},
                ...
                "text": "Rate",
                "channel": "ChoRte",
                "range": {"min": 0, "max": 20.0, "defaultValue": 0.96, "skew": 0.5, "increment": 0.001}
            }
        ]
    },
    {
        "type": "groupBox",
        "font": {"size": 11},
        "channel": "groupBox_253",
        "bounds": {"left": 440, "top": 125, "width": 310, "height": 110},
        "text": "Reverb",
        "children": [
            {
                "type": "checkBox",
                "font": {"colour": {"on": "#dddddd", "off": "#000000"}, "size": 8},
                "defaultValue": 1,
                "bounds": {"left": 15, "top": 30, "width": 60, "height": 15},
                "channel": "RvbOnOff",
                "text": "On/Off"
            },
            {
                ...
                "font": {"size": 9},
                "colour": {"tracker": {"background": "#222222", "width": 14}},
                "bounds": {"left": 90, "top": 25, "width": 60, "height": 80},
                "text": "Mix.",
                "channel": "RvbMix",
            ...
            },
            {
                ...
                "text": "Size",
                "channel": "RvbSize",
                "range": {"min": 0.4, "max": 1, "defaultValue": 0.8, "skew": 2, "increment": 0.001}
            },
            {
                "type": "rotarySlider",
                "font": {"size": 9},
                "colour": {"tracker": {"background": "#222222", "width": 14}},
                "bounds": {"left": 210, "top": 25, "width": 60, "height": 80},
                "text": "Damping",
                "channel": "RvbDamp",
                "range": {"min": 200, "max": 18000, "defaultValue": 8000, "skew": 0.5, "increment": 1}
            }
        ]
    },
    {
        ...
        "channel": "label_255",
        "bounds": {"left": 10, "top": 321, "width": 110, "height": 12},
        "text": "Iain McCurdy |2012|"
    },
    {
        "type": "keyboard",
        "channel": "keyboard_254",
        "bounds": {"left": 10, "top": 240, "width": 740, "height": 80}
    }
]
</Cabbage>
