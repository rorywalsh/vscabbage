...
<Cabbage>
form size(960, 260), caption("Modulating Delays"), pluginId("mdel"), colour("Black"), guiMode("queue")
...
label   bounds(  5,244, 170, 12), text("Author: Iain McCurdy |2013|"), FontColour("grey")
...
instr    1
 ...
 aL,aR         ins 
 kMinTime      cabbageGetValue    "MinTime"
 kMaxTime      cabbageGetValue    "MaxTime"
 kMinTime      portk              kMinTime,kMinTime            
 kMaxTime      portk              kMaxTime,kMaxTime            
 kspread       cabbageGetValue    "spread"
 kMinRate      cabbageGetValue    "MinRate"
 kMaxRate      cabbageGetValue    "MaxRate"
 kMinFB        cabbageGetValue    "MinFB"
 kMaxFB        cabbageGetValue    "MaxFB"
 kwidth        cabbageGetValue    "width"
 kMinTone      cabbageGetValue    "MinTone"
 kMaxTone      cabbageGetValue    "MaxTone"
 ...
 kGateActive   cabbageGetValue    "GateActive"
 kOnThreshold  cabbageGetValue    "OnThreshold"
 kOffThreshold cabbageGetValue    "OffThreshold"
 kRiseTime     cabbageGetValue    "RiseTime"
 kRelTime      cabbageGetValue    "RelTime"

 kRvbAmt       cabbageGetValue    "RvbAmt"
 ...
 if kGateActive==1 then
  ...
  if krms>kthreshold then
   ...
   kthreshold  =                  kOnThreshold
               cabbageSetValue    "gating", koff
  else
   kgate       =                  0
   kthreshold  =                  kOffThreshold
               cabbageSetValue    "gating",kon
  endif    
 ...
 ktrig         trigger            kGateActive,0.5,1
               cabbageSetValue    "gating",koff,ktrig
