...
<Cabbage>
form caption("Ursa Major Space Station"), size(680, 415), pluginId("UMSS"), colour("white"), guiMode("queue")
...
label   bounds(  5,402, 120, 12), text("Iain McCurdy |2021|"), fontColour("darkGrey"), align("left")
</Cabbage>
