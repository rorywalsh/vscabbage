...
<Cabbage>
form caption("Crossed Delays") size(815, 142), pluginId("CrDl"), colour("Black"), guiMode("queue")
...
rslider  bounds( 75, 20, 90, 90), text("Tempo"), channel("Tempo"), valueTextBox(1), textBox(1), range(20,500,60,1,0.1), trackerColour(100,200,100)
rslider  bounds(140, 20, 90, 90), text("Mix"), channel("Mix"), valueTextBox(1), textBox(1), range(0,1,0.5,1,0.01), trackerColour(100,200,100)
rslider  bounds(205, 20, 90, 90), text("Feedback"), channel("Feedback"), valueTextBox(1), textBox(1), range(0,3,0.5,1,0.01), trackerColour(100,200,100)
...
rslider  bounds( 75, 20, 90, 90), text("Freq.1"), channel("Freq1"), valueTextBox(1), textBox(1), range(-6000,6000,200,1,1), trackerColour(100,200,100)
rslider  bounds(140, 20, 90, 90), text("Freq.2"), channel("Freq2"), valueTextBox(1), textBox(1), range(-6000,6000,333,1,1), trackerColour(100,200,100)
}
...
rslider  bounds(-10, 20, 90, 90), text("Pan 1"), channel("Pan1"), valueTextBox(1), textBox(1), range(0,1,0), trackerBackgroundColour(100,200,100), trackerColour("black")
rslider  bounds( 55, 20, 90, 90), text("Pan 2"), channel("Pan2"), valueTextBox(1), textBox(1), range(0,1,1), trackerColour(100,200,100)
rslider  bounds(120, 20, 90, 90), text("Level"), channel("Level"), valueTextBox(1), textBox(1), range(0,1,1), trackerColour(100,200,100)
}

label     bounds( 5,127, 110, 12), text("Iain McCurdy |2016|")
...
instr    1
 ...
 if kClockSource==1 then                              ; if internal clock source has been chosen...
  ...
  ktempo         cabbageGetValue    "bpm"             ; tempo taken from host BPM
 ...
 kDiv1           cabbageGetValue    "Div1"
 kDiv2           cabbageGetValue    "Div2"
 kModType        cabbageGetValue    "ModType"
 ...
 kPan1           cabbageGetValue    "Pan1"
 kPan2           cabbageGetValue    "Pan2"
