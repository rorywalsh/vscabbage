...
<Cabbage>
form caption("Gate Reverb"), size(850,100), pluginId("GtRv"), colour(13, 50, 67,50)
image              bounds(  0,  0,850,100), colour("DarkSlateGrey"),  shape("sharp")
...
image    bounds(  0,  5,135, 95), colour(0,0,0,0), outlineColour("white"), outlineThickness(2), shape("sharp"), plant("delays")
{
...
image    bounds(133,  5,194, 95), colour(0,0,0,0), outlineColour("white"), outlineThickness(2), shape("sharp"), plant("scatter")
{
...
image    bounds(325,  5,112, 95), colour(0,0,0,0), outlineColour("white"), outlineThickness(2), shape("sharp"), plant("InputOutputMode")
{
label    bounds(  8,  8, 95, 12), text("Input/Output"), fontColour(200,250,200)
combobox bounds(  8, 21, 95, 20), channel("InOutMode"), text("Mono","Stereo Match","Stereo Diff."), value(3), fontColour(250,250,150), align("centre")
...
image    bounds(435,  5,282, 95), colour(0,0,0,0), outlineColour("white"), outlineThickness(2), shape("sharp"), plant("Filter")
{
label    bounds(  8,  8, 85, 12), text("Filter"), fontColour(200,250,200)
combobox bounds(  8, 21, 85, 20), channel("FiltSelect"), text("Bypass","Lowpass","Bandpass"), value(1), fontColour(250,250,150), align("centre")
...
image    bounds(715,  5,135, 95), colour(0,0,0,0), outlineColour("white"), outlineThickness(2), shape("sharp"), plant("mixer")
{
...
label    bounds(  3, 88,120, 10), text("Iain McCurdy |2015|"), align("left"), fontColour("Silver")
