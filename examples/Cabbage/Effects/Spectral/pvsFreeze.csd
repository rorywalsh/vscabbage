...
image bounds(  0,  0,270, 85), colour(  0,160,80), corners(10), outlineColour("white"), outlineThickness(4)
{
...
image bounds(270,  0,190, 85), colour(  0,160,80), corners(10), outlineColour("white"), outlineThickness(4)
{
...
rslider bounds( 60, 10, 60, 65), text("Delay"),     channel("delay"),  textColour("white"), range(0.0001, 0.5, 0.1, 1,0.001), colour(  0,100, 50,255), trackerColour("white")
rslider bounds(120, 10, 60, 65), text("Threshold"), channel("thresh"), textColour("white"), range(0.001, 0.5, 0.1,1,0.001),   colour(  0,100, 50,255), trackerColour("white")
}

image   bounds(460,  0,200, 85), colour(  0,160,80), corners(10), outlineColour("white"), outlineThickness(4)
{
...
rslider bounds( 70, 10, 60, 65), text("Mix"),      channel("mix"),       range(0, 1.00, 1),        textColour("white"), colour(  0,100, 50,255), trackerColour("white")
rslider bounds(130, 10, 60, 65), text("Level"),    channel("lev"),       range(0, 1.00, 0.5, 0.5), textColour("white"), colour(  0,100, 50,255), trackerColour("white")
}

label   bounds( 5,87,120,12), text("Iain McCurdy . 2017"), fontColour("white"), align("left")
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-d -n
