...
; Control      -    control mode: 1. GUI knob, 2. MIDI keyboard notes 
...
; Shape        -    the exponent of powershaping (waveshaping) that can be applied to the modulator waveform. A value of mean means no waveshaping.
...
<Cabbage>
form caption("Ring Modulator") size(845,190), pluginId("rmod"), colour(50,100,50), guiMode("queue")
image               pos(0, 0), size(845,110), colour("black"), shape("rounded"), outlineColour(50,100,50), outlineThickness(5) 
label    bounds( 10, 20, 65, 13), text("Control"), fontColour("white")
combobox bounds( 10, 34, 65, 18), text("Knob","Keybd."), channel("input"), textColour("white"), value(1)
rslider bounds( 65, 12, 90, 90), text("Freq."),    channel("freq"),  range(0, 15000, 800, 0.25),   colour("yellow"),    trackerColour("white"), textColour("white"), valueTextBox(1)

vslider bounds(145, 12,  6, 90), text("1"),     channel("1"),   range(0, 1, 1, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(155, 12,  6, 90), text("2"),     channel("2"),   range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(165, 12,  6, 90), text("3"),     channel("3"),   range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(175, 12,  6, 90), text("4"),     channel("4"),   range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(185, 12,  6, 90), text("5"),     channel("5"),   range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(195, 12,  6, 90), text("6"),     channel("6"),   range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(205, 12,  6, 90), text("7"),     channel("7"),   range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(215, 12,  6, 90), text("8"),     channel("8"),   range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(225, 12,  6, 90), text("9"),     channel("9"),   range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(235, 12,  6, 90), text("10"),    channel("10"),  range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(245, 12,  6, 90), text("11"),    channel("11"),  range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(255, 12,  6, 90), text("12"),    channel("12"),  range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(265, 12,  6, 90), text("13"),    channel("13"),  range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")
vslider bounds(275, 12,  6, 90), text("14"),    channel("14"),  range(0, 1, 0, 0.5),   colour("yellow"),    trackerColour("white"), textColour("white")


rslider bounds(285, 22, 70, 70), text("Shape"),   channel("shape"),range(0.125, 64, 1,0.5),          colour("yellow"),    trackerColour("white"), textColour("white")

line    bounds(360,  2,  3,106), colour(50,100,50)

rslider bounds(370, 22, 70, 70), text("Env."),     channel("env"),   range(0, 1.00, 0.0, 0.5,0.001), colour("orange"),    trackerColour("white"), textColour("white")
rslider bounds(440, 12, 40, 40), text("Att."),     channel("att"),   range(0.001, 2, 0.01, 0.5),   colour("orange"),    trackerColour("white"), textColour("white")
rslider bounds(440, 56, 40, 40), text("Dec."),     channel("dec"),   range(0.001, 2, 0.1,  0.5),   colour("orange"),    trackerColour("white"), textColour("white")

line    bounds(485,  2, 3, 106), colour(50,100,50)

rslider bounds(495, 22, 70, 70), text("Thresh"),   channel("thresh"),   range(0, 1.00, 0, 0.5,0), colour("orange"),    trackerColour("white"), textColour("white")
rslider bounds(560, 12, 40, 40), text("Min."),     channel("min"),   range(0, 13, 5),   colour("orange"),    trackerColour("white"), textColour("white")
rslider bounds(560, 56, 40, 40), text("Max."),     channel("max"),   range(0, 13, 8),   colour("orange"),    trackerColour("white"), textColour("white")

line    bounds(605,  2,  3,106), colour(50,100,50)

rslider bounds(620, 22, 70, 70), text("Width"),    channel("width"), range(0, 1.0, 0.0,1,0.001),   colour("chocolate"), trackerColour("white"), textColour("white")
rslider bounds(690, 22, 70, 70), text("Mix"),      channel("mix"),   range(0, 1.00, 1),            colour("chocolate"), trackerColour("white"), textColour("white")
rslider bounds(760, 22, 70, 70), text("Level"),    channel("level"), range(0, 1.00, 1),            colour("chocolate"), trackerColour("white"), textColour("white")

keyboard bounds(0,112,845,78)

label    bounds(720,  4,120, 11), text("Iain McCurdy |2012|"), align("right"), fontColour("silver")
</Cabbage>
