...
<Cabbage>
form caption("pvsCross") size(370,110), pluginId("crss"), guiMode("queue")
image            bounds(0, 0, 370,110), colour("Cream"), outlineColour("silver"), outlineThickness(5)
...
label    bounds(  4, 96,120, 11), text("Iain McCurdy |2012|"), align("left"), fontColour("darkGrey")
</Cabbage>
<CsoundSynthesizer>
