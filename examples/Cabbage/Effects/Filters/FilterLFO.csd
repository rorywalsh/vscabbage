...
rslider  bounds(645, 11, 70, 70), text("Rate Div."),colour( 30, 30 ,30),    trackerColour("white"), fontColour("white"), channel("LFOBPMDiv"), range(1,128, 1, 1, 1), markerColour("silver")
...
rslider  bounds(645, 91, 70, 70), text("Rate Div."),colour( 30, 30 ,30),    trackerColour("white"), fontColour("white"), channel("LFOBPMDiv2"), range(1,128, 1, 1, 1), markerColour("silver")
