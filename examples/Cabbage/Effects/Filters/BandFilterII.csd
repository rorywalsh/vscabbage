...
rslider  bounds(105,560, 60, 85), range(0,1,0),  channel("HPF_res"), text("Res"), visible(0), textBox(1), colour("silver"), outlineColour("silver"), fontColour(150,150,150), textColour("black"), fontColour(150,150,150)
...
rslider  bounds(265,560, 60, 85), range(0,1,0),  channel("LPF_res"), text("Res"), visible(0), textBox(1), colour("silver"), outlineColour("silver"), fontColour(150,150,150), textColour("black")

combobox bounds(370,565, 95, 20), channel("PassRej"), text("Bandpass","Bandreject","Bypass"), value(1)

hslider bounds(330,605,170,15), range(0,0.1,0.03,0.75,0.0001),  channel("Smoothing"), textColour("white"), text("Smoothing")

hslider bounds(330,635,170,15), range(0,1,1),  channel("Gain"), textColour("white"), text("Gain")
}
label    bounds( 10,640,110, 12), text("Iain McCurdy |2015|"), align("left")
</Cabbage>
