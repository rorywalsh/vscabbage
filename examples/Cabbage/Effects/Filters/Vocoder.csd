...
<Cabbage>
form caption("Vocoder"), size(540, 508), pluginId("voco") guiMode("queue")
image               bounds(0,0,540,508), colour(255,255,150), shape("rounded"), outlineColour("white"), line(1)

soundfiler bounds( 80,  1,460,148), channel("beg","len"), channel("filer1"),  colour(0, 255, 255, 255), fontColour(160, 160, 160, 255)
line       bounds(  0,150,540,   1), colour("DarkSlateGrey")
soundfiler bounds( 80,151,460,148), channel("beg","len"), channel("filer2"),  colour(0, 255, 255, 255), fontColour(160, 160, 160, 255)
...
label      bounds( 84,  2,448, 12), text(""), align("left"), colour(0,0,0,0), fontColour(200,200,200), channel("stringbox1")
label      bounds( 84,152,448, 12), text(""), align("left"), colour(0,0,0,0), fontColour(200,200,200), channel("stringbox2")
...
combobox bounds(  1, 12, 85, 16), channel("CarSource"), value(1), text("Synth","Right chan")
label    bounds(  1, 30, 85, 11), text("Filter Steepness"), fontColour("black")
image    bounds(  0, 41, 87, 18), colour("black"), shape("sharp")
combobox bounds(  1, 42, 85, 16), channel("steepness"), value(2), text("12dB/oct","24dB/oct")
label    bounds( 11, 60, 60, 11), text("Synth Type"), fontColour("black")
image    bounds(  0, 71, 87, 18), colour("black"), shape("sharp")
combobox bounds(  1, 72, 85, 16), channel("SynType"), value(1), text("saw","square","pulse","noise")
}
...
label   bounds(  5,495,120, 12), text("Iain McCurdy |2012|"), align("left"), fontColour("darkSlateGrey")
...
instr    1    ; READ IN WIDGETS
 ...
 gkCarSource       cabbageGetValue     "CarSource"
 ...
 gkincr            cabbageGetValue     "incr"
 gkincr            portk               gkincr, kPortTime    
 gkBPGain          cabbageGetValue     "BPGain"
 gkHPGain          cabbageGetValue     "HPGain"
 gksteepness       cabbageGetValue     "steepness"
 gkSynType         cabbageGetValue     "SynType"
 gkgate            cabbageGetValue     "gate"
...
instr    98
                   cabbageSet          "filer1", "file", gSfilepath1
 Sname             cabbageGetFileNoExtension gSfilepath1
 
                   cabbageSet          "stringbox1","text",Sname
 gkFileChans1      init                filenchnls:i(gSfilepath1)
endin

instr    99
                   cabbageSet          "filer2", "file", gSfilepath2
 Sname             cabbageGetFileNoExtension gSfilepath2
                   cabbageSet          "stringbox2", "text", Sname
