...
<Cabbage>
form caption("Tuner"), size(295,110), pluginId("Tunr")
image            bounds(0,0,295,110), colour(50,50,80), outlineThickness(4), outlineColour("silver")
...
image    bounds( 76, 48,120, 34), colour(0,0,0), outlineThickness(2), outlineColour("silver")
label    bounds( 92, 50, 60, 30), text("---"), identChannel("NoteNameID"), fontColour("white")
label    bounds(142, 58, 60, 20), text("---"), identChannel("ErrorID"), fontColour("yellow")
checkbox bounds(  0, 58, 60, 14), text("mute"), colour:0( 55,255, 55), colour:1( 55,255, 55), channel("mute"), value(1), fontColour("white")
}
label   bounds(  0, 96,290, 11), text("Iain McCurdy |2017|"), align("right"), fontColour("silver")
