...
<Cabbage>
form caption("Speed Tilt Octophonic") size(1170,415), pluginId("Spt8"), guiMode("queue"), colour(40,40,40)
...
nslider  bounds(  5, 20, 70, 35), channel("Spd1"), range(0.9,1.1,1,1,0.001), text("Speed 1")
nslider  bounds( 90, 20, 70, 35), channel("Spd2"), range(0.9,1.1,1,1,0.001), text("Speed 2")
nslider  bounds(  5, 60, 70, 35), channel("Spd3"), range(0.9,1.1,1,1,0.001), text("Speed 3")
nslider  bounds( 90, 60, 70, 35), channel("Spd4"), range(0.9,1.1,1,1,0.001), text("Speed 4")
nslider  bounds(  5,100, 70, 35), channel("Spd5"), range(0.9,1.1,1,1,0.001), text("Speed 5")
nslider  bounds( 90,100, 70, 35), channel("Spd6"), range(0.9,1.1,1,1,0.001), text("Speed 6")
nslider  bounds(  5,140, 70, 35), channel("Spd7"), range(0.9,1.1,1,1,0.001), text("Speed 7")
nslider  bounds( 90,140, 70, 35), channel("Spd8"), range(0.9,1.1,1,1,0.001), text("Speed 8")
}
...
; speaker locations
image bounds(410,205,340,190), colour(0,0,0,0), outlineThickness(1), outlineColour("silver")
{
...
hslider  bounds(  0, 35,390, 20), channel("SpdRange"), text("Speed Range"), range(0.001, 0.5,0.01,1,0.0001), valueTextBox(1)
...
label      bounds(  5,401,110, 12), text("Iain McCurdy |2024|"), align("left")
...
instr 1
 ...
 ; calculate speed ratio for each speaker
 gkSpd1  =  1 + (kSpdRange * (iUnisonDist - gkDist1) )
 gkSpd2  =  1 + (kSpdRange * (iUnisonDist - gkDist2) )
 gkSpd3  =  1 + (kSpdRange * (iUnisonDist - gkDist3) )
 gkSpd4  =  1 + (kSpdRange * (iUnisonDist - gkDist4) )
 gkSpd5  =  1 + (kSpdRange * (iUnisonDist - gkDist5) )
 gkSpd6  =  1 + (kSpdRange * (iUnisonDist - gkDist6) )
 gkSpd7  =  1 + (kSpdRange * (iUnisonDist - gkDist7) )
 gkSpd8  =  1 + (kSpdRange * (iUnisonDist - gkDist8) )

 ; send delay times to number boxes
 cabbageSetValue "Spd1", gkSpd1
 cabbageSetValue "Spd2", gkSpd2
 cabbageSetValue "Spd3", gkSpd3
 cabbageSetValue "Spd4", gkSpd4
 cabbageSetValue "Spd5", gkSpd5
 cabbageSetValue "Spd6", gkSpd6
 cabbageSetValue "Spd7", gkSpd7
 cabbageSetValue "Spd8", gkSpd8
...
instr 3
 ...
 if i(gkNChans)==1 then
  a1         diskin2 gSfilepath, kSpeed*(gkSpd1), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a2         diskin2 gSfilepath, kSpeed*(gkSpd2), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a3         diskin2 gSfilepath, kSpeed*(gkSpd3), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a4         diskin2 gSfilepath, kSpeed*(gkSpd4), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a5         diskin2 gSfilepath, kSpeed*(gkSpd5), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a6         diskin2 gSfilepath, kSpeed*(gkSpd6), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a7         diskin2 gSfilepath, kSpeed*(gkSpd7), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a8         diskin2 gSfilepath, kSpeed*(gkSpd8), random:i(0,filelen:i(gSfilepath)*iInskip), 1
 else
  a1, a_     diskin2 gSfilepath, kSpeed*(gkSpd1), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a_, a2     diskin2 gSfilepath, kSpeed*(gkSpd2), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a3, a_     diskin2 gSfilepath, kSpeed*(gkSpd3), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a_, a4     diskin2 gSfilepath, kSpeed*(gkSpd4), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a5, a_     diskin2 gSfilepath, kSpeed*(gkSpd5), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a_, a6     diskin2 gSfilepath, kSpeed*(gkSpd6), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a7, a_     diskin2 gSfilepath, kSpeed*(gkSpd7), random:i(0,filelen:i(gSfilepath)*iInskip), 1
  a_, a8     diskin2 gSfilepath, kSpeed*(gkSpd8), random:i(0,filelen:i(gSfilepath)*iInskip), 1
 endif
