...
; If C3 plays a 200Hz tone, C#3 plays 400Hz, D3 600Hz and so on.
...
<Cabbage>
form caption("...") size(159,230), pluginId("Ryth"), guiMode("queue")

label   bounds(  4,  3, 18, 22), text("R"), fontColour("red")
label   bounds( 18,  5, 18, 22), text("H"), fontColour("yellow")
label   bounds( 33,  2, 18, 22), text("Y"), fontColour("orchid")
label   bounds( 48,  4, 18, 22), text("T"), fontColour("LightGreen")
label   bounds( 63,  2, 18, 22), text("H"), fontColour("OrangeRed")
label   bounds( 80,  6, 18, 22), text("M"), fontColour("orange")
label   bounds( 95,  1, 18, 22), text("I"), fontColour("SkyBlue")
label   bounds(108,  4, 18, 22), text("C"), fontColour("Tomato")
label   bounds(123,  1, 18, 22), text("O"), fontColour("LightGreen")
label   bounds(138,  3, 18, 22), text("N"), fontColour("violet")
...
label   bounds( 17, 34, 30, 10), text("BASE"), fontColour("white")
...
label   bounds( 64, 34, 30, 10), text("RATE"), fontColour("white")
...
checkbox bounds(  0,151,  9, 10), channel("k1"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds(  9,151, 10, 10), channel("k2"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 19,151,  9, 10), channel("k3"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 28,151, 10, 10), channel("k4"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 38,151, 10, 10), channel("k5"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 48,151,  8, 10), channel("k6"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 56,151, 10, 10), channel("k7"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 66,151,  8, 10), channel("k8"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 74,151, 10, 10), channel("k9"),  colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 84,151,  9, 10), channel("k10"), colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds( 93,151, 10, 10), channel("k11"), colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds(103,151,  9, 10), channel("k12"), colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds(112,151,  9, 10), channel("k13"), colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds(121,151, 10, 10), channel("k14"), colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds(131,151,  9, 10), channel("k15"), colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds(140,151, 10, 10), channel("k16"), colour:0( 50, 50,  0), colour:1(255,255, 50)
checkbox bounds(150,151, 10, 10), channel("k17"), colour:0( 50,  0,  0), colour:1(255, 50, 50)
...
if inum=(59+$N) then                              ; if note number played on the keyboard corresponds to 'this' toggle light... (note that first note will be C3 (59 + 1)
 ik$N    cabbageGetValue           "k$N"          ; read current value for 'this' toggle light (at i-time)
         cabbageSetValue           "k$N",1 - ik$N ; write the inverse to it (i.e. toggle it)
 giVels[inum-59]   =               ivel           
endif
#
...
kk1               cabbageGetValue  "k1"
kk2               cabbageGetValue  "k2"
kk3               cabbageGetValue  "k3"
kk4               cabbageGetValue  "k4"
kk5               cabbageGetValue  "k5"
kk6               cabbageGetValue  "k6"
kk7               cabbageGetValue  "k7"
kk8               cabbageGetValue  "k8"
kk9               cabbageGetValue  "k9"
kk10              cabbageGetValue  "k10"
kk11              cabbageGetValue  "k11"
kk12              cabbageGetValue  "k12"
kk13              cabbageGetValue  "k13"
kk14              cabbageGetValue  "k14"
kk15              cabbageGetValue  "k15"
kk16              cabbageGetValue  "k16"
...
kbase             cabbageGetValue  "base"                             ; base pitch as a note number
krate             cabbageGetValue  "rate"                             ; rate of pulsation of fundemental
krate             portk            krate, kporttime
klevel            cabbageGetValue  "level"                            ; output amplitude level
ksync             cabbageGetValue  "k17"                              ; syncopation mode
kBaseFrq          =                cpsmidinn(kbase)
kBaseFrq          portk            kBaseFrq,kporttime
gkAmp             cabbageGetValue  "level"
amix              =                0

#define    LAYER(N)
#
kk$N              cabbageGetValue  "k$N"
