...
; Use right-click and drag to 'fling' the circular widgets into perpetual motion.  
...
<Cabbage>
form caption("Sonic Lava Lamp") size(510, 525), pluginId("sonl"), colour(50,50,50), guiMode("queue")
...
label bounds(  5,512,100, 12), text("Iain McCurdy 2012"), align("left"), fontColour("Silver")
</Cabbage>
