...
<Cabbage>
form caption("Windmills") size(700,500), colour(150,150,255), guiMode("queue"), pluginId("WnMl")
; SUN
image bounds(610, 20,70,70), colour(250,250,100), shape("ellipse")            ; sun

; CLOUDS
image bounds( 30,50,40,40), colour(240,240,240), shape("ellipse"), channel("cloud1_a")
image bounds( 50,30,60,60), colour(240,240,240), shape("ellipse"), channel("cloud1_b")
image bounds( 90,50,40,40), colour(240,240,240), shape("ellipse"), channel("cloud1_c")
image bounds( 52,70,56,20), colour(240,240,240), shape("sharp"),   channel("cloud1_d")

image bounds(125, 90, 60,60), colour(240,240,240), shape("ellipse"), channel("cloud2_a")
image bounds(155, 60, 90,90), colour(240,240,240), shape("ellipse"), channel("cloud2_b")
image bounds(215, 90, 60,60), colour(240,240,240), shape("ellipse"), channel("cloud2_c")
image bounds(160,120, 80,30), colour(240,240,240), shape("sharp"),   channel("cloud2_d")

image bounds(290, 80, 25, 25), colour(240,240,240), shape("ellipse"), channel("cloud3_a")
image bounds(305, 65, 35, 35), colour(240,240,240), shape("ellipse"), channel("cloud3_b")
image bounds(330, 80, 25, 25), colour(240,240,240), shape("ellipse"), channel("cloud3_c")
image bounds(302, 90, 36, 15), colour(240,240,240), shape("sharp"),   channel("cloud3_d")

; WINDMILL 1
image bounds( 96,150,  8,200), colour("white"), shape("sharp")                 ; post
image bounds( 92,142, 16, 16), colour("white"), shape("ellipse")                ; joint
image bounds( 98,154,  0,  0), colour("white"), shape("ellipse"), channel("Axle1")    ; axle
...
image bounds(548,224,  0,  0), colour("white"), shape("ellipse"),   channel("Axle3")    ; axle
...
image bounds(298,174,  0,  0), colour("white"), shape("ellipse"),   channel("Axle2")    ; axle
...
image bounds(600,474,  0,  0), colour("white"), shape("ellipse"),   channel("Axle4")    ; axle
image bounds(  0,  0,  0,  0), colour("white"), shape("ellipse"), widgetArray("CircleSeven4",7)

; BLACK OUT SCREEN
image bounds(  0,  0,700,500), colour("black"), shape("sharp"), channel("Blackout")

; INSTRUCTIONS
label    bounds(  0, 0,  0, 0), text("Blow into your microphone..."), align(centre), fontColour("white"), channel("instructions1")        ; Instructions
...
instr    1
 ...
 iCount = 1
 while iCount <= 6 do
 SWidget           sprintf             "bounds(  0,  0,  0,  0), colour(\"white\"), shape(\"ellipse\"), channel(\"CircleSix1_ident%d\")", iCount
                   cabbageCreate       "image", SWidget
 iCount            +=                  1
 od
 iCount = 1
 while iCount <= 9 do
 SWidget           sprintf             "bounds(  0,  0,  0,  0), colour(\"white\"), shape(\"ellipse\"), channel(\"CircleNine3_ident%d\")", iCount
                   cabbageCreate       "image", SWidget
 iCount            +=                  1
 od
 iCount = 1
 while iCount <= 7 do
 SWidget           sprintf             "bounds(  0,  0,  0,  0), colour(\"white\"), shape(\"ellipse\"), channel(\"CircleSeven2_ident%d\")", iCount
                   cabbageCreate       "image", SWidget
 iCount            +=                  1
 od
 iCount = 1
 while iCount <= 7 do
 SWidget           sprintf             "bounds(  0,  0,  0,  0), colour(\"white\"), shape(\"ellipse\"), channel(\"CircleSeven4_ident%d\")", iCount
                   cabbageCreate       "image", SWidget
 iCount            +=                  1
 od
 ...
 if kCloudTrig1==1 then
  ...
  Smess1d          sprintfk    "bounds( %d,70,56,20)",52+kCloudOffset1
                   cabbageSet  1, "cloud1_a", Smess1a
                   cabbageSet  1, "cloud1_b", Smess1b
                   cabbageSet  1, "cloud1_c", Smess1c
                   cabbageSet  1, "cloud1_d", Smess1d
 ...
 elseif kCloudTrig2==1 then
  ...
  Smess2d          sprintfk    "bounds(%d,120, 80,30)",160+kCloudOffset2
                   cabbageSet  1, "cloud2_a", Smess2a
                   cabbageSet  1, "cloud2_b", Smess2b
                   cabbageSet  1, "cloud2_c", Smess2c
                   cabbageSet  1, "cloud2_d", Smess2d
 ...
 elseif kCloudTrig3==1 then
  ...
  Smess3d          sprintfk    "bounds(%d, 90, 40, 15)",302+kCloudOffset3
                   cabbageSet  1, "cloud3_a", Smess3a
                   cabbageSet  1, "cloud3_b", Smess3b
                   cabbageSet  1, "cloud3_c", Smess3c
                   cabbageSet  1, "cloud3_d", Smess3d
