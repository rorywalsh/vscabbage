...
<Cabbage>
form caption("Oscilloscope Opcode Explorer"), size(930, 460), pluginId("osci"), colour( 20, 20, 20,150)
...
label    bounds(  5,446,110, 12), text("Iain McCurdy |2013|"), align("left"), fontColour("silver")
</Cabbage>
