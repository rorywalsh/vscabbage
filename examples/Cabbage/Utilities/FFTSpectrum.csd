...
#define RSLIDERSTYLE textBox(1), valueTextBox(1)
...
rslider bounds(105, 70,90, 90), channel("OscillatorFreq"), text("Osc. Freq."), range(0,11025,300,0.5,1), visible(0), identChannel("OscFreqID"), $RSLIDERSTYLE
rslider bounds(195, 70,90, 90), channel("PW"), text("Pulse Width"), range(0.005,0.995,0.005,1,0.001), visible(0), identChannel("PWID"), $RSLIDERSTYLE
rslider bounds(195, 70,90, 90), channel("NH"), text("Num. Harms."), range(1,160,40,1,1), visible(0), identChannel("Buzz1ID"), $RSLIDERSTYLE
rslider bounds(285, 70,90, 90), channel("LH"), text("Lowest Harm."), range(1,20,1,1,1), visible(0), identChannel("Buzz2ID"), $RSLIDERSTYLE
rslider bounds(375, 70,90, 90), channel("Mul"), text("Power Mult."), range(0,2,1,1,0.001), visible(0), identChannel("Buzz3ID"), $RSLIDERSTYLE
rslider bounds(465, 70,90, 90), channel("AudioGain"), text("Audio Gain"), range(0,5.00,0.0,0.5), $RSLIDERSTYLE
rslider bounds(195, 70,90, 90), channel("ModFreq"), text("Mod. Freq."), range(0,3000,300,0.4,0.1), visible(0), identChannel("FM1ID"), $RSLIDERSTYLE
rslider bounds(285, 70,90, 90), channel("Index"), text("Index"), range(0,20,0), visible(0), identChannel("FM2ID"), $RSLIDERSTYLE
combobox bounds(375, 60, 80, 20), channel("FM_PM"), text("Freq. Mod.","Phase Mod."), value(1), identChannel("FM3ID"), visible(0)
rslider bounds(185, 70,90, 90), channel("HsbBrite"), text("Brite"), range(-16,16,0), visible(0), identChannel("hsboscil1ID"), $RSLIDERSTYLE
rslider bounds(265, 70,90, 90), channel("HsbTone"), text("Tone"), range(-1,1,0), visible(0), identChannel("hsboscil2ID"), $RSLIDERSTYLE
rslider bounds(345, 70,90, 90), channel("HsbRange"), text("Octave Count"), range(2,12,2,1,1), visible(0), identChannel("hsboscil3ID"), $RSLIDERSTYLE
}
...
checkbox bounds(  0,130,100,13), channel("Phaser"), text("Phaser2"), radioGroup(1)
...
label      bounds(500,667,110, 12), text("Iain McCurdy |2014|"), align("right"), fontColour("grey")
</Cabbage>                                                   
