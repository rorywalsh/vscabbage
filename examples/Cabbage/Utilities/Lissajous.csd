...
<Cabbage>
form caption("Lissajous") size(595, 854), guiMode("queue"), pluginId("def1"), colour(40,40,60)
...
signaldisplay bounds( 10, 10, 500, 500), backgroundColour(255,255,255), colour(0,0,0), alpha(0.85), displayType("lissajous"), zoom(-1), signalVariable("aSigX", "aSigY"), channel("display")z
...
image    bounds( 12,520,570,320), colour(0,0,0,0), outlineThickness(2) 
{
...
listbox  bounds(235,240, 90, 40), text("SINE","8-Harm"), value(2), channel("OscYTab"), highlightColour("yellow"), fontColour("DarkGrey"), align("centre")
...
label    bounds( 12,841,110, 12), text("Iain McCurdy |2023|"), align("left"), fontColour("silver")
...
kGrid   cabbageGetValue "Grid"
        cabbageSet      changed:k(kGrid),"display","alpha", 1-kGrid*0.15
