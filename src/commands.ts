 ...
 */
    ...
    static async setupWebViewPanel(context: vscode.ExtensionContext) {
        ...
        this.panel.webview.html = ExtensionUtils.getWebViewContent(mainJS, styles, cabbageStyles, interactJS, widgetWrapper, colourPickerJS, colourPickerStyles, null, isDarkTheme);
        return this.panel;
